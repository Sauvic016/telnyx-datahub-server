...
const recordGetterFast = async (
    ...
    console.log("\n========== [recordGetterFast] START ==========");
    console.log("[recordGetterFast] Input params:", {
        startIndex,
        limit,
        pageType,
        recordTab,
    ...
    if (filter?.filterDateType) {
        ...
        console.log("[recordGetterFast] Date filter resolved:", { filterDateType: filter.filterDateType, startDate, endDate });
    }
  ...
  -------------------------------------------------- */
    ...
    console.log("[recordGetterFast] Sorting by:", sortField, "Order:", sortOrderValue);
    ...
    console.log("[recordGetterFast] Found properties:", properties.length, "Total:", total);
    ...
    console.log("[recordGetterFast] Final combined items:", finalItems.length);
    console.log("========== [recordGetterFast] END ==========\n");
